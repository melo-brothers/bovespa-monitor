...
@user_router.delete(
    "/favorite/remove/{user_id}", response_model=StandardOutput, responses={400: {"model": ErrorOutput}}
)
...
@assets_router.get(
    "/day_summary/{user_id}", response_model=List[DaySummaryOutput], responses={400: {"model": ErrorOutput}}
)
